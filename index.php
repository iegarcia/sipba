					...
					<div class="row icon_boxes_row">
						...
						<div class="col-xl-4 col-lg-6">
							<div class="icon_box">
								...
								<div class="icon_box_text">Una correcta estrategia terapéutica consiste en la evaluación del problema. SIPBA, en este sentido, recurre a las últimas herramientas neuropsicológicas, Psicométricas y Proyectivas para una valoración exhaustiva de la situación a abordar. Paralelamente esta valoración incluye la visión clínica interdisciplinaria a cargo de profesionales con alta experiencia. En el caso de niños y adolescentes se suman entrevistas y evaluación con participación de los padres o familia responsable del menor.</div>
							</div>
						</div>
				...
				<div class="row icon_boxes_row">
					...
					<div class="col-xl-4 col-lg-6">
						<div class="icon_box">
							...
							<div class="icon_box_text">La Terapia Cognitivo-Conductual (TCC) es un nombre genérico que se refiere a conjunto de terapias que se generaron a partir de los aportes de Aaron Beck y Albert Ellis en la década de 1960.</div>
						</div>
					</div>
